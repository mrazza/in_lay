...
namespace netAudio.core.tagLib.Id3v2
{
	...
	public static class FrameFactory
	{
		...
		internal delegate Frame FrameCreator (ByteVector data, int offset,
		                                    FrameHeader header,
		                                    byte version);
		...
		/// </exception>
		internal static Frame CreateFrame (ByteVector data,
		...
		/// </exception>
		internal static void AddFrameCreator (FrameCreator creator)
		{
			if (creator == null)
