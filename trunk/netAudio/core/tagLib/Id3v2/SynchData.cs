...
namespace netAudio.core.tagLib.Id3v2 {
	/// <summary>
	...
	public static class SynchData
	{
		...
		/// </exception>
		internal static uint ToUInt (ByteVector data)
		{
			if (data == null)
		...
		/// </exception>
        internal static ByteVector FromUInt(uint value)
		{
			if ((value >> 28) != 0)
		...
		///    <paramref name="data" /> is <see langword="null" />.
		/// </exception>
        internal static void UnsynchByteVector(ByteVector data)
		{
			if (data == null)
				throw new ArgumentNullException ("data");
		...
		///    <paramref name="data" /> is <see langword="null" />.
		/// </exception>
        internal static void ResynchByteVector(ByteVector data)
		{
			if (data == null)
				throw new ArgumentNullException ("data");
