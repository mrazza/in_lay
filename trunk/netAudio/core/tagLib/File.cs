...
namespace netAudio.core.tagLib {
	...
	internal abstract class File
	{
		...
		///    A IFileAbstraction object representing the
		///    file to be read.
		/// </param>
		/// <param name="mimetype">
		...
		/// </remarks>
		internal delegate File FileTypeResolver (IFileAbstraction abstraction,
		                                       string mimetype,
		                                       ReadStyle style);
		...
		///    file as stored in the IFileAbstraction
		...
		/// </param>
		/// <remarks>
		///    In order to remove all tags from a file, pass as <paramref name="types" />.
		/// </remarks>
		...
		/// <summary>
		///    This class implements IFileAbstraction
		...
		/// </remarks>
		internal class LocalFileAbstraction : IFileAbstraction
		{
			/// <summary>
		...
		/// <code lang="C#">using netAudio.core.tagLib;
		///using Gnome.Vfs;
		///
		///internal class ReadTitle
		///{
		...
		///}
		///
		///internal class VfsFileAbstraction : tagLib.File.IFileAbstraction
		///{
		///    private string name;
		///
		...
		///                Vfs.Shutdown()</code>
		/// </example>
		internal interface IFileAbstraction
		{
			/// <summary>
