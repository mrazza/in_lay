...
namespace netAudio.core.tagLib.Mpeg {
	...
	/// </summary>
	internal struct AudioHeader : IAudioCodec
	{
		...
		/// </value>
		/// <remarks>
		///    If <see cref="XingHeader" /> is equal to XingHeader.Unknown and <see
		///    cref="SetStreamLength" /> has not been called, this value
		///    will not be correct.
		///    If <see cref="VBRIHeader" /> is equal to VBRIHeader.Unknown and <see
		///    cref="SetStreamLength" /> has not been called, this value
		///    will not be correct.
		/// </remarks>
		...
		///    instance, or XingHeader.Unknown if no
		///    header was found.
		/// </value>
		...
		///    header found in the audio represented by the current
		///    instance, or VBRIHeader.Unknown if no
		///    header was found.
		/// </value>
		...
		///    recommended to use Find(AudioHeader&amp;,tagLib.File,long,int)
		///    instead.
		/// </remarks>
		public static bool Find (out AudioHeader header,
		                         tagLib.File file, long position)
