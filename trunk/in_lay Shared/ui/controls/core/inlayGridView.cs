...
{
    /// <summary>
    /// Abstract in_lay GridView base
    /// </summary>
    public abstract class inlayGridView : gooeyGridView, IPlayerControl
    {
        #region Members
        /// <summary>
        ...
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="inlayGridView"/> class.
        /// </summary>
        public inlayGridView()
            : base()
        {
            _iSystem = null;
        }
