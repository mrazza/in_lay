...
{
    /// <summary>
    /// Abstract in_lay ListView base
    /// </summary>
    public abstract class inlayListView : gooeyListView, IPlayerControl
    {
        #region Members
        /// <summary>
        ...
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="inlayListView"/> class.
        /// </summary>
        public inlayListView()
            : base()
        {
            _iSystem = null;
        }
