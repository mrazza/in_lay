...
{
    /// <summary>
    /// Abstract netGooey Tab Control Implementation
    /// </summary>
    public abstract class gooeyTabControl : TabControl, IGooeyControl
    {
        #region Members
        /// <summary>
        /// gooeySystem Root
        ...
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="gooeyTabControl"/> class.
        /// </summary>
        public gooeyTabControl()
            : base()
        {
